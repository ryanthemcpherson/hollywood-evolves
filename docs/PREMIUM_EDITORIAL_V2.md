...
- **Tick 3 — exact-head review and release decision:** pending. Re-run fresh independent design and code review against the current PR head, require exact-head CI green, then merge and deploy only after PASS.
